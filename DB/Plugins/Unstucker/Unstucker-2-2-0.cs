...
namespace Eax.Plugins
{
    ...
    {        
        ...
        public Version Version { get { return new Version(2, 2, 0); } }
        ...
        public void OnBotStop(IBot bot)
        {
            LastCheckTime = DateTime.Now;
        }
        ...
        public void OnPulse()
        {
            ...
            if (LoggedPositions.Count > 5 && DateTime.Now.Subtract(LastCheckTime).TotalSeconds > CheckInterval)
            {
