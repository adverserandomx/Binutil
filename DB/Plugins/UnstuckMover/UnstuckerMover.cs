...
namespace Eax.Plugins
{
    ...
    {        
		private const bool LeaveGameOnReallyStuck = false;
        ...
        private const int MinimumMoveDistance = 2;
        ...
        public string Author { get { return "eax/unhb"; } }
        public string Description { get { return "Unstucks you."; } }
        public string Name { get { return "UnstuckerMover v" + Version.ToString(); } }
        ...
        public void OnPulse()
        {
            ...
            //    Log("Checking positions...");
                ...
                {
                    Log("Your character appears to be not moving.");
					...
					// Let the other anti-idle code restart profiles and what not
					if (LeaveGameOnReallyStuck)
					{
